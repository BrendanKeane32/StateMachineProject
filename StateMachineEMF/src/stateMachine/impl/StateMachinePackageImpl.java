...
public class StateMachinePackageImpl extends EPackageImpl implements StateMachinePackage {
	...
	public void createPackageContents() {
		...
		createEReference(modelEClass, MODEL__STATEMACHINES);
	...
	public void initializePackageContents() {
		...
		initEReference(getModel_Statemachines(), this.getStateMachine(), null, "statemachines", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
